...
<div align="center">
	...
	<c:choose>
		...
		<c:otherwise>
			<img id="infopre" src="/?????????????.png" alt="기본이미지" style="width:200; height: 200" />
		</c:otherwise>
	</c:choose>
	<script>
	...
	<div>
		...
		<a href="/my/???????"><button type="submit" style="width: 150px;">Revised INFO </button></a>
		<a href="/index"><button type="button" style="width: 150px;">RETURN MAIN</button></a>
		
		
		<!--  탈퇴는 보류 -->
		<a href="/my/drop"><button type="submit" style="width: 150px;">탈퇴하기</button></a>
