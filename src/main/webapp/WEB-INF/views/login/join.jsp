...
<!--  아이디  닉네임  패스워드   이메일  성별  나이  -->
		<p>
                <b>YEAR </b><br/>
                <select name="age" style="width: 100%;padding: 5px;
	font-family: 맑은 고딕; ">
        ...
        <p>
         <b>GENDER </b><br/>
	   	남 <input type="radio" name="gender" value="man" checked="checked" style="width: 40%" /> 여<input type="radio" name="gender" value="woman" style="width: 40%"/>
        </p>
			...
			document.getElementById("eck").onkeyup = function() {
				...
				var xhr = new XMLHttpRequest();
					...
					xhr.open("post","/join/signup_check/email" ,true);
			...
			<button id="join" type="submit" disabled="disabled">C R E A T E</button>
		   <br/>
